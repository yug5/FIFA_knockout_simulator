...
public class ScoringService {
    ...
    public void recalculateScores(Long matchId) {
        ...
        for (Participant participant : participants) {
            recalculateParticipantScore(participant);
        }

        participantRepository.saveAll(participants);
    }

    public void recalculateParticipantScore(Participant participant) {
        ...
        int bonus = participant.getBonusPoints() != null ? participant.getBonusPoints() : 0;
        participant.setTotalScore(totalScore + bonus);
    }
}
